...
import { CalendarCheck, Clock, ListChecks, MessageSquare, Plus, Star } from "lucide-react";
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div>
              ...
              <p className="text-neutral-600">Manage your services and bookings</p>
            </div>
            <Button onClick={() => navigate("/dashboard/add-service")}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            <Card>
              <CardContent className="p-6 flex justify-between items-center">
                <div>
                  <p className="text-sm text-neutral-500 mb-1">Active Services</p>
            ...
            <Card>
              <CardContent className="p-6 flex justify-between items-center">
                <div>
                  <p className="text-sm text-neutral-500 mb-1">Pending Bookings</p>
            ...
            <div className="lg:col-span-2">
              <Tabs defaultValue="services" className="w-full">
                <TabsList className="w-full mb-4">
                  <TabsTrigger value="services" className="flex-1">My Services</TabsTrigger>
                  ...
                  {servicesLoading ? (
                        ...
                        <Card key={service.id}>
                          <CardContent className="p-6">
                            <div className="flex flex-col md:flex-row justify-between">
                              <div className="flex">
                                <div className="w-20 h-20 bg-neutral-200 rounded-md overflow-hidden mr-4 flex-shrink-0">
                              ...
                              <div className="flex flex-row md:flex-col gap-2 mt-4 md:mt-0">
                                ...
                                <Button 
                                  size="sm" 
                                  onClick={() => navigate(`/dashboard/add-service?edit=${service.id}`)}
                                >
                                  Edit
                                </Button>
                              </div>
                    ...
                    <Card>
                      <CardContent className="p-6 text-center">
                        <p className="text-neutral-500 mb-4">You haven't added any services yet.</p>
                        <Button onClick={() => navigate("/dashboard/add-service")}>
                          <Plus className="mr-2 h-4 w-4" />
                          Add First Service
                        </Button>
                ...
                <TabsContent value="bookings">
                  {bookingsLoading ? (
                            ...
                            <div className="flex flex-col md:flex-row justify-between">
                              ...
                              <div className="flex flex-row md:flex-col gap-2 mt-4 md:mt-0">
                                ...
                                <Button 
                                  ...
                                  size="sm" 
                                  onClick={() => navigate(`/dashboard/messages?user=${booking.customer.id}`)}
                                >
                                  Message
                                </Button>
                              </div>
                    ...
                    <Card>
                      <CardContent className="p-6 text-center">
                        <p className="text-neutral-500">You don't have any upcoming bookings.</p>
                      </CardContent>
                    </Card>
                  )}
                </TabsContent>
                  ...
                  {messagesLoading ? (
                    ...
                    <div className="text-center py-4">
                      <p className="text-neutral-500 text-sm">
                        No messages yet. Customers will contact you here when interested in your services.
                      </p>
                    </div>
                  )}
                </CardContent>
